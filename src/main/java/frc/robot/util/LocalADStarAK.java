...
public class LocalADStarAK implements Pathfinder {
     ...
     *         pathfinder
     */
    @Override public PathPlannerPath getCurrentPath(PathConstraints constraints, GoalEndState goal_end_state) {
        if (!Logger.hasReplaySource()) {
     ...
     *            be moved to the nearest
     *            non-obstacle node.
     */
    @Override public void setStartPosition(Translation2d start_position) {
        if (!Logger.hasReplaySource()) {
     ...
     *            non-obstacle node.
     */
    @Override public void setGoalPosition(Translation2d goal_position) {
        if (!Logger.hasReplaySource()) {
     ...
     *            Translation2d represents opposite corners
     *            of a bounding box.
