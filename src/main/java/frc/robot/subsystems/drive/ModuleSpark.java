...
public class ModuleSpark extends ModuleIO {
    ...
    public ModuleSpark(int module) {
        ...
        SparkUtil.tryUntilOk(
                turn_spark,
                5,
                () -> turn_spark.configure(
                        turnConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters));

        // Create odometry queues
        timestamp_queue = SparkOdometryThread.getInstance().makeTimestampQueue();
        drive_position_queue = SparkOdometryThread.getInstance().registerSignal(drive_spark,
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        SparkUtil.ifOk(drive_spark, drive_encoder::getVelocity, (value) -> inputs.drive_velocity_radians_per_second = value);
        SparkUtil.ifOk(
                drive_spark,
        ...
        SparkUtil.ifOk(turn_spark, turn_encoder::getVelocity, (value) -> inputs.turn_velocity_radians_per_second = value);
        SparkUtil.ifOk(
                turn_spark,
